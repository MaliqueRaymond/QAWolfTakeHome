I have added my repo with other projects attached below you will see the steps taken to run the script using npm install playright then node index.js you will be able to run the playright.
